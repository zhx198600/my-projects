...
import { generateReviewAnalysis } from './reviewService';

export function generateMockProduct(url: string, platform: 'jd' | 'tmall'): ProductInfo {
  ...
  return {
    ...
    url,
    platform,
    reviewAnalysis: generateReviewAnalysis(randomProduct.title)
  };
}
