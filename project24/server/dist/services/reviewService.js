...
exports.generateMockReviews = generateMockReviews;
exports.analyzeReviews = analyzeReviews;
exports.generateReviewAnalysis = generateReviewAnalysis;
...
function getRatingFromSentiment(sentiment) {
...
function generateMockReviews(productTitle) {
    const reviews = [];
...
function generateReviewAnalysis(productTitle) {
